...
@implementation QuestionMarkImage

-(instancetype)initWithFrame:(CGRect)frame {
    self = [super initWithFrame:frame];
    if (self) {
        [self setShapeColor:[UIColor greenColor]];
...
-(void)drawRect:(CGRect)rect
{
    ...
    CGContextSetStrokeColorWithColor(context, _shapeColor.CGColor);
    ...
    //// Text Drawing
    CGRect textRect = CGRectMake(0, 0, 60, 60);
    {
        NSString* textContent = @"?";
        UIFont* textFont = [UIFont systemFontOfSize: 20];
        [_shapeColor setFill];
        [textContent drawInRect: CGRectOffset(textRect, 0, (CGRectGetHeight(textRect) - [textContent sizeWithFont: textFont constrainedToSize: textRect.size lineBreakMode: UILineBreakModeWordWrap].height) / 2) withFont: textFont lineBreakMode: UILineBreakModeWordWrap alignment: UITextAlignmentCenter];
    }
